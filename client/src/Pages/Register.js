                ...
                <Form className="col-lg-8" onSubmit={handleSubmitReg}>
                    ...
                    <Form.Row>
                        <Form.Group controlId="forName" className="col-lg-8">
                            ...
                            <Form.Control type="text" name="name" placeholder="Dennis G" onChange={handleChanges} required />
                            <Form.Text muted>
                    ...
                    <Form.Row>
                        <Form.Group controlId="formBasicEmail" className="col-lg-12">
                            ...
                            <Form.Control type="email" name="email" placeholder="den@gmail.com" onChange={handleChanges} required />
                        </Form.Group>
                    </Form.Row>
                    <Form.Row>
